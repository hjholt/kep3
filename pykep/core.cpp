...
#undef PYKEP3_EXPOSE_LEG_SF_ATTRIBUTES
    ...
    py::class_<kep3::leg::sims_flanagan_alpha> sims_flanagan_alpha(m, "_sims_flanagan_alpha", pykep::leg_sf_docstring().c_str());
    ...
    sims_flanagan_alpha.def_property(
        ...
        "Talphas vector used in the simulation");  // Add docstring
...
#undef PYKEP3_EXPOSE_LEG_SF_ATTRIBUTES
    ...
    sims_flanagan_alpha.def(
        "compute_mc_grad",
        [](const kep3::leg::sims_flanagan_alpha &leg) {
            auto tc_cpp = leg.compute_mc_grad();
            // Lets transfer ownership to python of the three
            const std::array<double, 49> &rs_addr = std::get<0>(tc_cpp);
            const std::array<double, 49> &rf_addr = std::get<1>(tc_cpp);
...
#undef PYKEP3_EXPOSE_LEG_SF_HF_ATTRIBUTES
    ...
    sims_flanagan_hf_alpha.def(
        "compute_mc_grad",
        [](const kep3::leg::sims_flanagan_hf_alpha &leg) {
            auto tc_cpp = leg.compute_mc_grad();
            // Lets transfer ownership to python of the three
            std::array<double, 49> &rs_addr = std::get<0>(tc_cpp);
            std::array<double, 49> &rf_addr = std::get<1>(tc_cpp);
