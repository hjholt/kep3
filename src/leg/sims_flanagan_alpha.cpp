...
std::pair<std::array<double, 49>, std::vector<double>> sims_flanagan_alpha::gradients_multiple_impulses(
...
sims_flanagan_alpha::gradients_fwd(std::vector<double>::const_iterator th1, std::vector<double>::const_iterator th2,
                             // NOLINTNEXTLINE(bugprone-easily-swappable-parameters)
...
std::pair<std::array<double, 49>, std::vector<double>>
sims_flanagan_alpha::gradients_bck(std::vector<double>::const_iterator th1, std::vector<double>::const_iterator th2,
                             // NOLINTNEXTLINE(bugprone-easily-swappable-parameters)
...
std::tuple<std::array<double, 49>, std::array<double, 49>, std::vector<double>> sims_flanagan_alpha::compute_mc_grad() const
{
    // Preliminaries
...
std::vector<double> sims_flanagan_alpha::compute_tc_grad() const
{
