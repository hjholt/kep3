...
kep3_DLL_PUBLIC heyoka::expression zero_hold_cr3bp_jacobi_C();

// Returns the effective potential of the cr3bp (heyoka expression). 6 states, 1 parameter: mu.
kep3_DLL_PUBLIC heyoka::expression zero_hold_cr3bp_effective_potential_U();
...
kep3_DLL_PUBLIC const heyoka::taylor_adaptive<double> &get_ta_zero_hold_cr3bp_var(double tol); // variational (x,y,z,vx,vy,vz,m) first order
